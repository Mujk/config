...
alias cat = bat
alias powlvl = cat /sys/class/power_supply/BAT0/capacity
...
alias jo = joshuto
alias cl = clear
alias clearPac = sudo rm /var/lib/pacman/.db.lck # arch only
alias cheat = hx ~/Documents/cheatsheets/main-cheatsheet/README.md
alias shut = shutdown no
alias upAll = paru and rustup update and cargo cargo install-update -a
